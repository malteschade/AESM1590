...
% Output:
%         (t,v) or (tn,vn):
%         When closing the figure it will ask you to export your 
%         time-velocity picks: 
%         - If you click 'yes' then it will save them in either t & v, 
%           or if these are in use in tn & vn where n is an increasing
%           number so as not to overwrite previous picks. 
%         - If you click 'no' then t & v will not be saved in the workspace
%
